              ...
              <nav class="navbar navbar-expand-lg navbar-light tm-bg-white-transparent tm-navbar">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                  <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                      <div class="tm-nav-link-highlight"></div>
                      <a class="nav-link" href="changeAnyData.jsp">VOTE CONTROLS</a>
                    </li>
            ...
            <div class="wrapper wrapper--w680">
                <div class="card card-4">
                    <div class="card-body">
                        ...
                        <h2 class="title">ADMIN'S PAGE</h2>
                        
                        <h4><ul><li> <font color="Brown"> View user complaints here</font></li></ul></h4>
                         <h4><ul><li> <font color="Brown"> View Election results here </font></li></ul></h4>
                     </div>
                </div>
            </div>
        </div>
