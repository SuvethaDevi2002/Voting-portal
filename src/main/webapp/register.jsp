...
.invalid:before {
  ...
  <script type="text/javascript">  function validateForm()
  {
  	...
  	var p= document.getElementById("pd").value;
  	...
  	else if (n.trim()==null || n.trim()=="")
		{
		alert('Name is invalid');

		}
  	else if (d.trim()==null || d.trim()=="")
		{
		alert('DOB is invalid');

		}
  	else if (s.trim()==null || s.trim()=="")
		{
		alert('Serial number is invalid');

		}
  	else if (ph.trim()==null || ph.trim()=="")
		{
		alert('Phone number is invalid');

		}
  	else if (pa.trim()==null || pa.trim()=="")
		{
		alert('Password is invalid');

		}
  	
  	else if (p.trim()==null || p.trim()=="")
  		{
  		alert('Password is invalid');
              ...
              <nav class="navbar navbar-expand-lg navbar-light tm-bg-white-transparent tm-navbar">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                  <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <div class="tm-nav-link-highlight"></div>
                        <a class="nav-link" href="register.html"><span class="sr-only">(current)</span>REGISTER</a>
                      </li>
                  </ul>
                </div>
              </nav>
...
%>
                        ...
                        <form onsubmit="validateForm()" action = "./Register" method="POST">
                            <div class>
                              
                                <div class>
                                    <div class="input-group">
                                        <label class="label">EPIC Number</label>
                                        <input class="input--style-4" type="text" width="00" id = "EPIC_no" name="epic_no" placeholder = "Enter the EPIC number"  pattern="[A-Z]{3}[0-9]{7}"
                                        title="Enter a valid EPIC number" required>
                                    </div>
                                </div>
                                <div class=>
                                    <div class="input-group">
                                        <label class="label">Name (As per voter ID)</label>
                                        <input class="input--style-4" type="text" id="name" name="name"placeholder = "Enter your name" required><br>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class=>
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-icon">
                                            <input type="date"  min="1920-01-01" max = "2003-01-01" id="DOB" name="dob"placeholder = "Enter your DOB" required><br>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="p-t-10">
                                            <label class="radio-container m-r-45">Male
                                                <input type="radio" checked="checked" id = "m" name="gender" value="male" required><br>
                                                <span class="checkmark"></span>
                                            </label>
                                            <label class="radio-container">Female
                                                <input type="radio" name="gender" id="f" value="female" required><br>
                                                <span class="checkmark"></span>
                                            </label>
                                            <label class="radio-container">Transgender
                                                <input type="radio" name="gender" id="t" value="transgender"required><br>
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="row row-space">
                                <div class>
                                    <div class="input-group">
                                        <label class="label">Serial number(As per VOTER ID)</label>
                                        <input class="input--style-4" type="number" id="s" name="serial_noSS"placeholder = "Enter the serial number" required><br>
                                    </div>
                                </div>
                                <div class=>
                                    <div class="input-group">
                                        <label class="label">Phone Number</label>
                                        <input class="input--style-4" type="text" id="phone" name="phone" placeholder = "Enter your phone  number"  pattern="[0-9]{10}" 
                                        title="Enter a valid Phone number"required><br>
                                    </div>
                                </div>
                                <div class=>
                                    <div class="input-group">
